...
public class SudokuBoard {
    ...
    public void startAutomaticGame(){
        ...
        for(i = 1; i<coordinates.size(); i++){
            fillBoard(i);
            SudokuGraph graphRight = new SudokuGraph(base);
            SudokuGraph graphLeft = new SudokuGraph(base);
            Player player = new Player(base, graphRight.getColumnHeadRoot(), graphLeft.getColumnHeadRoot(), board);
            try{
